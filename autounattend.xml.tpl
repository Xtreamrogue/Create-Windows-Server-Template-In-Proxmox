...
{% endif %}
				...
				<SynchronousCommand wcm:action="add">
					<CommandLine>powershell -File e:\scripts\set-temp.ps1</CommandLine>
					<Order>12</Order>
					<Description>Set Temp Folders</Description>
				</SynchronousCommand>
				<SynchronousCommand wcm:action="add">
					<CommandLine>powershell -File e:\scripts\disable-server-manager.ps1</CommandLine>
					<Order>13</Order>
					<Description>Disable Server Manager</Description>
				</SynchronousCommand>
				<SynchronousCommand wcm:action="add">
					<CommandLine>powershell -File e:\scripts\enable-winrm.ps1</CommandLine>
					<Order>14</Order>
				...
				<SynchronousCommand wcm:action="add">
                    <CommandLine>c:\windows\system32\sysprep\sysprep /generalize /oobe /shutdown /unattend:C:\Windows\System32\Sysprep\unattend.xml </CommandLine>					
